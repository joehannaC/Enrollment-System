...
<%@page import="student.filterStudentProfiles" %>
...
<head>
  ...
  <title>Filter Student Profiles</title>
  ...
  <div class="profile-container">
      <%
          if(request.getMethod().equalsIgnoreCase("post")){
              ...
              filterStudentProfiles filter = new filterStudentProfiles();
              filter.setStudentType(studentType);
              List<String> studentProfiles = filter.filterStudProf();
