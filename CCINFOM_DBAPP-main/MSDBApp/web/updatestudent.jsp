...
<%@page import="student.updateStudProf_admin" %>
...
<body>
  ...
  <%
      ...
      try {
        ...
        // Check if the studentID exists before updating
        searchStudentProfiles search = new searchStudentProfiles();
        search.setStudentID(inp_studentID);
        ...
        if (!studentProfiles.isEmpty()) {
          ...
          updateStudProf_admin update = new updateStudProf_admin();
          int result = update.updateStudProf(inp_studentID, inp_studentType, inp_firstname, inp_middleInitial, inp_lastName,
              inp_birthDate, inp_gender, inp_schoolEmail, inp_phoneNum);
      ...
      %>
          <script>
            alert("Student ID does not exist. Please enter a valid student ID.");
            location.reload();
          </script>
      <%
        }
