...
<%@page import="student.updateStudentProfiles" %>
  ...
  <%
      ...
      try {
        ...
        if (!studentProfiles.isEmpty()) {
          ...
          updateStudentProfiles update = new updateStudentProfiles();
          int result = update.updateStudProf(inp_studentID, inp_firstname, inp_middleInitial, inp_lastName,
